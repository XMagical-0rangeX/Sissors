...
let lizEl = document.getElementById("btn4");
let spoEl = document.getElementById("btn5");
...
lizEl.addEventListener("click", liz);
spoEl.addEventListener("click", spo);
...
function rock(){
    if(oneplayvar){
    let challenge = Math.floor(Math.random()*5)+1
